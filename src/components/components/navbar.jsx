    ...
    <header className="sticky top-0 z-10 bg-white backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-gray-200">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <nav className={`md:flex ${mobileMenuOpen ? 'flex-col items-center' : 'hidden md:flex'} gap-4`}>
          <NavLink href="/" text="Home" onClick={() => setMobileMenuOpen(false)} />
          <NavLink href="/login" text="Login" onClick={() => setMobileMenuOpen(false)} />
          <NavLink href="/signup" text="Signup" onClick={() => setMobileMenuOpen(false)} />
          <NavLink href="/team-selection" text="Team Selection" onClick={() => setMobileMenuOpen(false)} />
        </nav>
      </div>
    </header>
  );
...
function NavLink({ href, text, onClick }) {
  return (
    <Link href={href} className="group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-12 font-medium transition-colors hover:bg-gray-900 hover:text-gray-50 focus:bg-gray-900 focus:text-gray-50 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:hover:bg-gray-50 dark:hover:text-gray-900 dark:focus:bg-gray-50 dark:focus:text-gray-900" onClick={onClick}> 
        {text}
